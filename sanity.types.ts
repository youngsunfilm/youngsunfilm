...
export type AllSanitySchemaTypes = Timeline | SanityImageAssetReference | Milestone | Project | SanityImageCrop | SanityImageHotspot | Duration | Slug | Page | HomeReference | PageReference | ProjectReference | Settings | Home | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;

// Source: sanity/lib/queries.ts
// Variable: homePageQuery
// Query: *[_type == "home"][0]{    _id,    _type,    overview,    carouselImages[]{      ...,    },    showcaseProjects[]{      _key,      ...@->{        _id,        _type,        coverImage,        overview,        "slug": slug.current,        tags,        title,      }    },    title,  }
